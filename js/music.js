$(function(){
    ...
    var musicImgsData = ['pics/taopao.png','pics/huahuo.jpeg','pics/TT.png']    // 图片地址数组
    var musicNameData = ['夜空中最亮的星','打上花火','Time Travel'];                   // 歌曲名数组
    var artistNameData = ['逃跑计划','DAOKO','岸部真明']            // 创作歌手数组
    var musicUrls=['mp3/逃跑计划.mp3','mp3/打上花火.mp3','mp3/TimeTravel.mp3'];// 歌曲mp3数组
